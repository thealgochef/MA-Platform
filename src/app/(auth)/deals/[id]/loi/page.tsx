  ...
  return (
    <main className="min-h-screen bg-light-gray py-8">
      <div className="max-w-2xl mx-auto px-4">
        <h1 className="text-2xl font-bold text-navy mb-2">Submit Letter of Intent</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-text-primary mb-1">Timing *</label>
            <input
              type="text"
              value={timing}
