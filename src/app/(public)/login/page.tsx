...
function LoginContent() {
  ...
  const handleGoogleLogin = async () => {
    ...
    if (invitation) {
      callbackUrl.searchParams.set("invitation", invitation);
    }
    ...
    <main className="min-h-screen flex items-center justify-center bg-surface text-text">
      <div className="bg-bg rounded-xl shadow-md p-8 w-full max-w-md">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-primary text-bg rounded-md py-3 px-4 font-medium hover:bg-btn-hover transition-colors"
        >
